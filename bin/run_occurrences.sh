...
[
   {
     "Args": [
       ...
       "--deploy-mode",
       "client",
      "--packages","io.projectglow:glow-spark3_2.12:1.2.1,io.delta:delta-core_2.12:2.1.0",
      "--exclude-packages",
...
aws emr create-cluster \
  ...
  --bootstrap-actions Path="s3://kf-strides-232196027141-datalake-${env}/jobs/bootstrap-actions/enable-ssm.sh" Path="s3://kf-strides-232196027141-datalake-${env}/jobs/bootstrap-actions/install-java11.sh" Path="s3://kf-strides-232196027141-datalake-${env}/jobs/bootstrap-actions/download_human_reference_genome.sh" \
  --steps "${steps}" \
