...
val sparkDepsSetting = Seq(
  libraryDependencies ++= Seq(
    ...
    "org.apache.spark" %% "spark-sql" % "3.5.0" % Provided, //emr-7.0.0
    "org.apache.spark" %% "spark-hive" % "3.5.0" % Provided, //emr-7.0.0
    "org.apache.hadoop" % "hadoop-client" % "3.3.6" % Provided, //emr-7.0.0
    "org.apache.hadoop" % "hadoop-aws" % "3.3.6" % Provided, //emr-7.0.0
    "io.delta" %% "delta-spark" % "3.1.0" % Provided, //emr-7.0.0
